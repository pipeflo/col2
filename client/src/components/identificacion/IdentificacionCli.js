...
class Identificacion extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.beneficiario.citas.length > 0) {
  ...
  onClick = e => {
    ...
    if (e.target.value === 'BORRAR') {
      ...
      const identificacionData = {
        ...
        access_token: this.props.app.access_token
      };
      console.log('enviando a buscar usuario:', identificacionData);
      this.props.buscarBenediciarioCli(identificacionData);
...
Identificacion.propTypes = {
  buscarBenediciarioCli: PropTypes.func.isRequired,
...
export default connect(
  mapStateToProps,
  { buscarBenediciarioCli, reiniciarCompra }
)(Identificacion);
